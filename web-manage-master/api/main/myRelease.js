const myRelease = async (req,res,sqlMain,moment,baseUrl,selectUser) => {
	...
	'community.id,public_status,review_status,review_dec,article_type,nickName,avatar,title,content,image_path,community.create_time,priview_address,code_address,star_status','user',"community",
